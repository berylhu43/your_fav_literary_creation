...
from .services import _resolve_external_id, get_recommendations
...
def pick(request):
    ...
    if external_id is None:
        return render(request, "recommendations/not_found.html", {"title": title})
    return redirect(
        "catalog:select_work", media_type=media_type, external_id=external_id
    )
